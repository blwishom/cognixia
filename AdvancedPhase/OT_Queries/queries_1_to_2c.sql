...
# Query 2c
SELECT products.product_name, products.list_price, quantity
FROM products
LEFT JOIN inventories
	ON products.product_id = inventories.warehouse_id
LEFT JOIN product_categories
	ON inventories.quantity = product_categories.category_id
