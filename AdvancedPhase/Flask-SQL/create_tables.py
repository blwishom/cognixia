...
def main():
    ...
    make_author_table = """CREATE TABLE IF NOT EXISTS author (
                                id integer PRIMARY KEY,
                                name text NOT NULL
                            );"""

    make_category_table = """CREATE TABLE IF NOT EXISTS category (
                                id integer PRIMARY KEY,
                                name text NOT NULL
                            );"""

    make_book_table = """CREATE TABLE IF NOT EXISTS book (
                            id integer PRIMARY KEY,
                            name text NOT NULL,
                            published date,
