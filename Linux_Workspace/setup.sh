...
echo "Hello this file is located at the following directory: $mainDir" > mainFile.txt
echo "Look a secret file!!" > .mainsecret

# create directory, move into that directory
mkdir dirWithFiles
cd dirWithFiles
...
echo "File with more text
And a second line of text
Along with a third line" > text.txt

echo "File with more text
And a second line of text
The third line has some text" > otherText.txt


echo "I hear the drums echoing tonight
...
I bless the rains down in Africa
(Gonna take the time)
Gonna take some time to do the things we never had (ooh, ooh)" > africa_by_toto.txt
...
I had virtually no rehearsal for that." > beemovie.txt
...
# create directory with many subdirectories
mkdir topDir
cd topDir

# files and folders for the textFiles directory
mkdir textFiles
touch textFiles/empty.txt 
echo "Hello!!!" > textFiles/hello.txt 
mkdir textFiles/important 
echo "very important text in this file" > textFiles/important/veryImportant.txt

# make file for scripts folder
mkdir scripts
...
chmod u+x scripts/myscript.sh



# last folder that contains other stuff
mkdir otherFiles

touch otherFiles/.secretFile
...
" > otherFiles/Hello.java

mkdir -p otherFiles/dirA/dirB/dirC
mkdir -p otherFiles/dirA/dirD

echo "print('Hello World')" > otherFiles/dirA/dirD/Hello.py
